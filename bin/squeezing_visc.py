#/usr/bin/env python #author: lgpang
#email: lgpang@qq.com
...
def squeezing(tau0, sys='RHIC', b=10.0, tdec=0.1, eB0=0.1, sigx=1.3, sigy=2.6, path_out='../results/event0', gpu_id=3):
    cfg.IEOS = 1
    cfg.TAUD = tdec
    cfg.EB0 = eB0
    cfg.SIGX = sigx
    ...
    visc.evolve(max_loops=2000, save_bulk=True, save_hypersf=True)
...
def dNdEta_tau0():
    ...
    #squeezing(tau0=0.4, sys='LHC', b=2.65, tdec=1.9, eB0=0.0, path_out='../results/squeezing_pbpb276_tau0p4_td1p9_eb0p00_visc_dt0p005/')
    #squeezing(tau0=0.4, sys='LHC', b=2.65, tdec=1.9, eB0=0.0, path_out='../results/squeezing_pbpb276_tau0p4_td1p9_eb0p00_visc/')
    squeezing(tau0=0.4, sys='RHIC', b=2.4, tdec=1.9, eB0=0.0, path_out='../results/squeezing_auau200_tau0p4_td1p9_eb0p00_visc/')
