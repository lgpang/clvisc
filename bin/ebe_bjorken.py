...
def event_by_event(fout, cent='30_35', idx=0, etaos=0.0,
    ...
    visc.smear_from_p4x4(parton_list, SIGR=0.6, SIGZ=0.6, KFACTOR=1.3, force_bjorken=True)
...
if __name__ == '__main__':
    ...
    path = '/lustre/nyx/hyihp/lpang/%s_results_bjorken/cent%s/etas%s/'%(collision_system,
              cent, etaos)
    path = path.replace('.', 'p')
