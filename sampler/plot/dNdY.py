...
if __name__=='__main__':
    ...
    Y1, dNdY_2decay = get_dNdY(fname='plot/pmag_2_body_decay.dat')
    #Y2, dNdY_23decay = get_dNdY(fname='build/pmag_2_and_3_body_decay.dat')
    Y2, dNdY_23decay = get_dNdY(fname='event_ideal/pmag_for_pion.dat')
    ...
    mc_scale, = ax.plot(Y0, 1.83096*dNdY_nodecay, 'r--', label='1.83096 * mc no decay')
